...
[TestFixture]
internal class RuleExecutor_ExecuteUnLinked_StartBreakRuleType
{
    [Test]
    public void ExecuteUnLinked_TRuleIsIUnLinkedRule_ExecutedRulesMustContainsOnlyRulesOfStartBreak()
    {
